...
pub const MRB_STR_EMBED_LEN_BITSIZE: u32 = 5;
...
extern "C" {
    pub fn mrb_intern_cstr(mrb: *mut mrb_state, str: *const ::std::os::raw::c_char) -> mrb_sym;
}
extern "C" {
    pub fn mrb_intern(
        arg1: *mut mrb_state,
...
extern "C" {
    pub fn mrb_run(mrb: *mut mrb_state, proc_: *mut RProc, self_: mrb_value) -> mrb_value;
}
extern "C" {
    pub fn mrb_top_run(
        mrb: *mut mrb_state,
...
pub union RArray__bindgen_ty_1 {
    ...
    pub ary: [*mut ::std::os::raw::c_void; 3usize],
...
extern "C" {
    pub fn mrb_string_cstr(mrb: *mut mrb_state, str: mrb_value) -> *const ::std::os::raw::c_char;
}
extern "C" {
...
extern "C" {
    pub fn mrb_utf8_len(str: *const ::std::os::raw::c_char, byte_len: mrb_int) -> mrb_int;
}
